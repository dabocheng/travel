...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = _react2['default'].createClass({
	  ...
	  render: function render() {
	    return _react2['default'].createElement('div', { className: 'nav' }, _react2['default'].createElement(_reactRouter.Link, { to: 'main' }, 'Home'), _react2['default'].createElement(_reactRouter.Link, { to: 'login' }, 'Login'), _react2['default'].createElement(_reactRouter.RouteHandler, null));
	  }
	});
